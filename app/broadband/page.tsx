...
export default function BroadbandPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      {/* Hero */}
      <section className="bg-gradient-to-br from-infratel-red to-red-600 text-white py-16 overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/20 backdrop-blur-sm mb-6">
                ...
                <span className="font-semibold">Fiber Optic Network</span>
              </div>
              ...
              <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                <Link
                  href="#plans"
                  className="inline-flex items-center px-8 py-4 bg-white text-infratel-red font-semibold rounded-lg hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl hover:scale-105"
                >
                  View Plans
                </Link>
            ...
            <div className="relative hidden lg:block">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                <img
                  src="/images/broadband-family.png"
                  alt="Family enjoying fast broadband at home"
